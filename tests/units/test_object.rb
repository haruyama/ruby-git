...
class TestObject < Test::Unit::TestCase
  ...
  def test_commit
    ...
    assert_equal('11-09-07', o.author.date.strftime('%m-%d-%y'))
    assert_equal('11-09-07', o.author_date.strftime('%m-%d-%y'))
    assert_equal('scott Chacon', o.committer.name)
    assert_equal('11-09-07', o.committer_date.strftime('%m-%d-%y'))
    assert_equal('11-09-07', o.date.strftime('%m-%d-%y'))
