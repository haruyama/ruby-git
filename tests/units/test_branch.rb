...
class TestBranch < Test::Unit::TestCase
  ...
  def test_branches_single
    ...
    assert_equal('working', b.name)
    assert_equal('remotes/working/master', b.full)
    assert_equal('remotes', b.remote.name)
    assert_equal(nil, b.remote.fetch_opts)
    assert_equal(nil, b.remote.url)
  end
